    ...
    <section data-scroll className='w-full h-screen bg-black text-white relative px-10'>
        <div className='flex justify-between pt-10'>
            <div className='flex flex-col gap-6 items-start'>
                <h4 className='text-[1.6vw] font-normal'>Relax. We've got you.</h4>
                <button type="button" className='border px-4 py-2 text-[0.8vw] rounded-lg'>Take a seat</button>
            </div>
            <div className='flex gap-10 text-[1.2vw]'>
